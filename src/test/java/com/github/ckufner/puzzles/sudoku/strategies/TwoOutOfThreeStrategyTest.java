...
@Tag("UnitTest")
class TwoOutOfThreeStrategyTest {
    @ParameterizedTest
    ...
    void twoOutOfThreeForRowsTest(int[][] puzzle, boolean expectedReturnValue, int[][] expectedPuzzle) {
        boolean actual = TwoOutOfThreeStrategy.twoOutOfThreeForRows(puzzle);
    ...
    void twoOutOfThreeForColumnsTest(int[][] puzzle, boolean expectedReturnValue, int[][] expectedPuzzle) {
        boolean actual = TwoOutOfThreeStrategy.twoOutOfThreeForColumns(puzzle);
